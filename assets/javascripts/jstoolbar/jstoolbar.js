...
function jsColorButton(title, scope, className, wiki_name) {
    if(typeof jsToolBar.strings == 'undefined') {
        this.title = title || null;
    } else {
        this.title = jsToolBar.strings[title] || title || null;
...
jsToolBar.prototype = {
    ...
    setWikiName: function(name) {
        this.wiki_name = name || 'wiki_name';
    },
    ...
    colorButton: function(toolName) {
        ...
        var b = new jsColorButton(tool.title, this, 'color', tool.wiki_name);
        return b;
    },
